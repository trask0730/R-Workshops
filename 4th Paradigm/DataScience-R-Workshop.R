...
## Questions ##
# 1. Do some googling, or look at the 3rd book listed under "Acknowledgements", to learn about logistic regression.
    # Do logistic regression on the Blue Sky Marathon data, or another data set of interest.
    # Interpret and plot your logistic regression model.
# 2. In the GitHub repository, there is another dataset "iris.csv".
    # Playa round with this data set! Some interesting thigns to do include:
      # Create multiple plots to visualize relationships between features. Color according to class of iris.
      # Find the correlation between pairs of the features. How does this relate to some of your plots?
# 3. Using the resources below, learn about and play with other common techniques in data science
    # Fun examples include: k-nearest neighbors, support vector machines, principal component analysis, and clustering.
    # Try these techniques on the iris dataset or another dataset from the UCI Machine Learning repo.
...
# I used the UC Irvine Machine Learning Repository to obtain the iris.csv dataset
